...
#'
#' Note that sampling random effects from their posterior as compared to calculating marginal standard devitions like \code{\link[TMB]{sdreport}} is particularly useful for multidimensional random effects (e.g. for locations \eqn{x} and \eqn{y})
#' because the joint distribution of the random effects is taken into account, which is not the case when calculating marginal standard deviations.
#'
#' @param obj
