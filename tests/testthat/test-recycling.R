...
recycling_specs <- list(
  ...
  list(f = "dhpois",     x = c(0, 1, 2, 3, 4),
       pars = list(lambda = c(1, 2, 3, 4, 5), zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "dhbinom",    x = c(0, 1, 2, 3, 4),
       pars = list(size = c(5, 10, 15, 20, 25), prob = c(.1, .2, .3, .4, .5),
                   zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "dhnbinom",   x = c(0, 1, 2, 3, 4),
       pars = list(size = c(1, 2, 3, 4, 5), prob = c(.1, .3, .5, .7, .9),
                   zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "dhnbinom2",  x = c(0, 1, 2, 3, 4),
       pars = list(mu = c(1, 2, 3, 4, 5), size = c(1, 2, 3, 4, 5),
                   zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "phpois",     x = c(0, 1, 2, 3, 4),
       pars = list(lambda = c(1, 2, 3, 4, 5), zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "phbinom",    x = c(0, 1, 2, 3, 4),
       pars = list(size = c(5, 10, 15, 20, 25), prob = c(.1, .2, .3, .4, .5),
                   zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "phnbinom",   x = c(0, 1, 2, 3, 4),
       pars = list(size = c(1, 2, 3, 4, 5), prob = c(.1, .3, .5, .7, .9),
                   zeroprob = c(.1, .3, .5, .7, .9))),
  list(f = "phnbinom2",  x = c(0, 1, 2, 3, 4),
       pars = list(mu = c(1, 2, 3, 4, 5), size = c(1, 2, 3, 4, 5),
                   zeroprob = c(.1, .3, .5, .7, .9))),
