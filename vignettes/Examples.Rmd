...
We use the function `make_matrices()` from package `LaMa` to conveniently create design and penalty matrices for the smooth functions, which uses `mgcv` internally.
