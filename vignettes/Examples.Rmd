...
We use the function `make_matrices()` from package `LaMa` (which uses `mgcv` internally) to conveniently create design and penalty matrices for the smooth functions.
