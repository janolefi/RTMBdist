...
* [`invgamma(shape, rate, scale)`](../reference/invgamma.html): Inverse gamma distribution parameterised by `shape`, `rate`, and `scale` of the corresponding gamma distribution
