...
P(X = x) = (1 - p_0)\\\frac{P\_{\mathrm{NB}}(x;\\r,\pi)}{1 - \pi^{r}},
\quad x = 1, 2, \ldots\$\$
...
a zero and may be larger *or* smaller than \\\pi^{r}\\. The two coincide
with the ordinary negative binomial when `zeroprob` equals \\\pi^{r}\\.
